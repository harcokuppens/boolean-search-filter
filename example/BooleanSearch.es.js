...
var E = {};
tt.d(E, { MG: () => N, fr: () => Xt, sR: () => Ve, Zo: () => et, iH: () => ze, rt: () => W, jB: () => He, M8: () => Pe, $t: () => Lt, aq: () => Ue, pG: () => Tt, eP: () => se, KU: () => lt, zW: () => re, IX: () => S, mY: () => D, a7: () => st, JG: () => y, ay: () => k, X2: () => Ot, WU: () => ne, Uw: () => Me, gw: () => _t, iX: () => oe, re: () => be, Pg: () => ae, tD: () => Fe, R$: () => O, Dj: () => Z, m7: () => nt, NZ: () => xt, xo: () => B, ou: () => u, qC: () => Nt, mD: () => G, Ay: () => kn });
class u {
  constructor() {
...
const Y = { toStringTree: function(o, t, e) {
...
class R extends x {
  ...
  equals(t) {
    return this === t || t instanceof R && this.hashCode() === t.hashCode() && this.returnState === t.returnState && (this.parentCtx == null ? t.parentCtx == null : this.parentCtx.equals(t.parentCtx));
  }
  toString() {
  ...
  static create(t, e) {
    return e === x.EMPTY_RETURN_STATE && t === null ? x.EMPTY : new R(t, e);
  }
}
class Dt extends R {
  constructor() {
...
function Wt(o, t) {
  ...
  const e = Wt(o, t.parentCtx), n = o.states[t.invokingState].transitions[0];
  return R.create(e, n.followState.stateNumber);
}
function Le(o, t, e) {
  ...
  let r = null;
  return r = i.length === 0 ? x.EMPTY : i.length === 1 ? R.create(i[0], o.getReturnState(0)) : new q(i, o.returnStates), t.add(r), e.set(r, r), e.set(o, r), r;
}
function Pt(o, t, e, n) {
  if (o === t) return o;
  if (o instanceof R && t instanceof R) return function(s, i, r, a) {
    if (a !== null) {
      let h = a.get(s, i);
    ...
    if (s.returnState === i.returnState) {
      ...
      const c = R.create(h, s.returnState);
  ...
  return o instanceof R && (o = new q([o.getParent()], [o.returnState])), t instanceof R && (t = new q([t.getParent()], [t.returnState])), function(s, i, r, a) {
    if (a !== null) {
      let m = a.get(s, i);
...
class w {
  ...
  set(t) {
    w._checkIndex(t), this._resize(t), this.data[t >>> 5] |= 1 << t % 32;
  }
  get(t) {
    w._checkIndex(t);
    const e = t >>> 5;
  ...
  equals(t) {
    return t instanceof w && ht(this.data, t.data);
  }
  toString() {
    return "{" + this.values().join(", ") + "}";
  }
  get length() {
    return this.data.map((t) => w._bitCount(t)).reduce((t, e) => t + e, 0);
  }
  _resize(t) {
    const e = t + 32 >>> 5;
...
class st {
  ...
  getDecisionLookahead(t) {
    ...
    for (let s = 0; s < e; s++) {
      n[s] = new D();
      const i = new M();
      this._LOOK(t.transition(s).target, null, x.EMPTY, n[s], i, new w(), !1, !1), (n[s].length === 0 || n[s].contains(st.HIT_PRED)) && (n[s] = null);
    }
    return n;
  }
  LOOK(t, e, n) {
    const s = new D(), i = (n = n || null) !== null ? Wt(t.atn, n) : null;
    return this._LOOK(t, e, i, s, new M(), new w(), !0, !0), s;
  }
    ...
    if (!i.has(h)) {
      ...
      for (let c = 0; c < t.transitions.length; c++) {
        ...
        if (d.constructor === Ct) {
          ...
          const p = R.create(n, d.followState.stateNumber);
          try {
...
class $t extends J {
  ...
  equals(t) {
    return this === t || t instanceof $t && this.channel === t.channel;
  }
  toString() {
...
class Xt {
  ...
  readEdges(t, e) {
    ...
    for (n = 0; n < t.states.length; n++) {
      ...
      else if (i instanceof wt) for (s = 0; s < i.transitions.length; s++) a = i.transitions[s].target, a instanceof X && (a.loopBackState = i);
    }
  }
  readDecisions(t) {
    const e = this.readInt();
  ...
  verifyATN(t) {
    if (this.deserializationOptions.verifyATN) for (let e = 0; e < t.states.length; e++) {
      ...
      else n instanceof wt ? (this.checkCondition(n.transitions.length === 1), this.checkCondition(n.transitions[0].target instanceof X)) : n instanceof it ? this.checkCondition(n.loopBackState !== null) : n instanceof de ? this.checkCondition(n.stopState !== null) : n instanceof at ? this.checkCondition(n.endState !== null) : n instanceof Rt ? this.checkCondition(n.startState !== null) : n instanceof ct ? this.checkCondition(n.transitions.length <= 1 || n.decision >= 0) : this.checkCondition(n.transitions.length <= 1 || n instanceof b);
    }
  }
  checkCondition(t, e) {
  ...
  stateFactory(t, e) {
    if (this.stateFactories === null) {
      const n = [];
      n[f.INVALID_TYPE] = null, n[f.BASIC] = () => new ue(), n[f.RULE_START] = () => new de(), n[f.BLOCK_START] = () => new ge(), n[f.PLUS_BLOCK_START] = () => new bt(), n[f.STAR_BLOCK_START] = () => new Ft(), n[f.TOKEN_START] = () => new sn(), n[f.RULE_STOP] = () => new b(), n[f.BLOCK_END] = () => new Rt(), n[f.STAR_LOOP_BACK] = () => new wt(), n[f.STAR_LOOP_ENTRY] = () => new X(), n[f.PLUS_LOOP_BACK] = () => new pe(), n[f.LOOP_END] = () => new it(), this.stateFactories = n;
    }
  ...
  lexerActionFactory(t, e, n) {
    if (this.actionFactories === null) {
      const s = [];
      s[0] = (i, r) => new $t(i), s[1] = (i, r) => new jt(i, r), s[2] = (i, r) => new Qt(i), s[3] = (i, r) => Vt.INSTANCE, s[4] = (i, r) => zt.INSTANCE, s[5] = (i, r) => new Zt(i), s[6] = (i, r) => Ut.INSTANCE, s[7] = (i, r) => new Jt(i), this.actionFactories = s;
    }
...
class W extends u {
  constructor(t, e, n, s, i) {
    super(), this.source = t !== void 0 ? t : W.EMPTY_SOURCE, this.type = e !== void 0 ? e : null, this.channel = n !== void 0 ? n : u.DEFAULT_CHANNEL, this.start = s !== void 0 ? s : -1, this.stop = i !== void 0 ? i : -1, this.tokenIndex = -1, this.source[0] !== null ? (this.line = t[0].line, this.column = t[0].column) : this.column = -1;
  }
  clone() {
    const t = new W(this.source, this.type, this.channel, this.start, this.stop);
    return t.tokenIndex = this.tokenIndex, t.line = this.line, t.column = this.column, t.text = this.text, t;
  }
  cloneWithType(t) {
    const e = new W(this.source, t, this.channel, this.start, this.stop);
...
class $ {
  ...
  equals(t) {
    return this === t || t instanceof $ && this.configs.equals(t.configs);
  }
  toString() {
...
`, e)), e.context === null || e.context.hasEmptyPath()) {
  ...
  getEpsilonTarget(t, e, n, s, i, r) {
    ...
    if (n.serializationType === g.RULE) {
      const l = R.create(e.context, n.followState.stateNumber);
...
const z = { SLL: 0, LL: 1, LL_EXACT_AMBIG_DETECTION: 2, hasSLLConflictTerminatingPrediction: function(o, t) {
  ...
  return t.hashFunction = function(e) {
    ...
    let n = t.get(e);
    n === null && (n = new w(), t.set(e, n)), n.set(e.alt);
  }), t.getValues();
}, getStateToAltMap: function(o) {
  const t = new dn();
  return o.items.map(function(e) {
    let n = t.get(e.state);
    n === null && (n = new w(), t.set(e.state, n)), n.set(e.alt);
  }), t;
...
class be extends H {
  ...
  adaptivePredict(t, e, n) {
    ...
    try {
      ...
      if (a = s.precedenceDfa ? s.getPrecedenceStartState(this.parser.getPrecedence()) : s.s0, a === null) {
        ...
        s.precedenceDfa ? (s.s0.configs = c, c = this.applyPrecedenceFilter(c), a = this.addDFAState(s, new $(null, c)), s.setPrecedenceStartState(this.parser.getPrecedence(), a)) : (a = this.addDFAState(s, new $(null, c)), s.s0 = a);
      }
  ...
  computeStartState(t, e, n) {
    const s = Wt(this.atn, e), i = new v(n);
  ...
  getPredicatePredictions(t, e) {
    ...
    for (let i = 1; i < e.length; i++) {
      const r = e[i];
      t !== null && t.get(i) && n.push(new we(r, i)), r !== A.NONE && (s = !0);
    }
    return s ? n : null;
  }
  ...
  ruleTransition(t, e) {
    ...
    const n = e.followState, s = R.create(t.context, n.stateNumber);
  ...
  getConflictingAltsOrUniqueAlt(t) {
    let e = null;
    return t.uniqueAlt !== N.INVALID_ALT_NUMBER ? (e = new w(), e.set(t.uniqueAlt)) : e = t.conflictingAlts, e;
  }
  getTokenName(t) {
...
const fn = { DFA: Pe, DFASerializer: ee, LexerDFASerializer: De, PredPrediction: we }, xn = { PredictionContext: x }, mn = { Interval: S, IntervalSet: D };
class ne {
  visitTerminal(t) {
  }
  visitErrorNode(t) {
...
class se extends Z {
  constructor(t, e, n) {
    ...
    s instanceof Re ? (this.ruleIndex = s.ruleIndex, this.predicateIndex = s.predIndex) : (this.ruleIndex = 0, this.predicateIndex = 0), this.predicate = e, this.offendingToken = t.getCurrentToken();
  }
}
function Sn(o, t) {
...
const ze = { fromString: function(o) {
  return new et(o, !0);
  ...
  return new Se(o, t);
} }, An = { arrayToString: G, stringToCharArray: function(o) {
...
Object.defineProperty(qe, "size", { get: function() {
  return this.tokens.length;
} });
class He extends qe {
  constructor(t, e) {
...
const kn = { atn: gn, dfa: fn, context: xn, misc: mn, tree: Tn, error: Cn, Token: u, CommonToken: W, CharStreams: ze, CharStream: et, InputStream: re, CommonTokenStream: He, Lexer: y, Parser: oe, ParserRuleContext: ae, Interval: S, IntervalSet: D, LL1Analyzer: st, Utils: An, TokenStreamRewriter: Nt };
var yn = E.MG, Ke = E.fr;
E.sR;
var In = E.Zo;
E.iH;
...
E.mY;
E.a7;
var vn = E.JG, Rn = E.ay, wn = E.X2;
E.WU;
var bn = E.Uw;
E.gw;
var Fn = E.iX, Dn = E.re, Pn = E.Pg, We = E.tD;
E.R$;
var Mn = E.Dj;
E.m7;
E.NZ;
...
const _ = class _ extends vn {
  constructor(t) {
    super(t), this._interp = new Rn(this, _._ATN, _.DecisionsToDFA, new We());
  }
  get grammarFileName() {
...
_.T__0 = 1, _.T__1 = 2, _.AND = 3, _.OR = 4, _.NOT = 5, _.STRING = 6, _.EMPTY = 7, _.WS = 8, _.EOF = $e.EOF, _.channelNames = ["DEFAULT_TOKEN_CHANNEL", "HIDDEN"], _.literalNames = [
  null,
  "'('",
  "')'"
], _.symbolicNames = [
...
const T = class T extends Fn {
  ...
  constructor(t) {
    super(t), this._interp = new Dn(this, T._ATN, T.DecisionsToDFA, new We());
  }
  // @RuleVersion(0)
  expr(t) {
    t === void 0 && (t = 0);
...
T.T__0 = 1, T.T__1 = 2, T.AND = 3, T.OR = 4, T.NOT = 5, T.STRING = 6, T.EMPTY = 7, T.WS = 8, T.EOF = $e.EOF, T.RULE_expr = 0, T.literalNames = [
  null,
  "'('",
  "')'"
], T.symbolicNames = [
...
class Zn {
  ...
  apply() {
    ...
    document.addEventListener("DOMContentLoaded", function() {
      const e = document.getElementById(`${t.id}_button`), n = document.getElementById(`${t.id}_searchbox`), s = document.getElementById(`${t.id}_searchForm`), i = document.getElementById(`${t.id}_answer`), r = document.getElementById(`${t.id}_error`);
...
//# sourceMappingURL=BooleanSearch.es.js.map
